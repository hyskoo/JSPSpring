...
<style>
body.login-page{
	background-image:url('<%=request.getContextPath()%>/resources/images/backimg.jpg');
...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			<a href="#"><b><h1>로그인</h1></b></a>
		</div>
		<!-- /.login-logo -->
		<div class="card">
		 <div class="card-body login-card-body">
			<p class="login-box-msg">스마트 시스템 For Naru</p>
				...
				<div class="row">
					<div class="col-sm-8">
						<div class="checkbox icheck">
							<label> <input type="checkbox"> 로그인 저장
							</label>
						</div>
					</div>
					<!-- /.col -->
