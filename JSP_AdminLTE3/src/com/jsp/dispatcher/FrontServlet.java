...
public class FrontServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		try {
			...
			System.out.println(handlerMapper + " 준비되었습니다.");
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println(handlerMapper + " 준비되지 않았습니다.");
		}
		
		try {
			this.viewResolver = (ViewResolver)injectionBean(viewResolverType);
			System.out.println(viewResolver + " 준비되었습니다.");
		} catch (Exception e) {
			e.printStackTrace();
			System.out.println(viewResolver + " 준비되지 않았습니다.");
		}
