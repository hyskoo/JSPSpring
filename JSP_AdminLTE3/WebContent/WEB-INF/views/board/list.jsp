    ...
    <section class="content">		
		<div class="card">
			<div class="card-header with-border">
				<button type="button" class="btn btn-primary" id="registBtn" onclick="OpenWindow('registForm.do','글등록',600,500);">글등록</button>				
				...
				<table class="table table-bordered text-center" >					
					...
					<c:forEach items="${dataMap.boardList }" var="board">
						<tr style='font-size:0.85em;'>
							...
							<a href="javascript:OpenWindow('detail.do${pageMaker.makeQuery(pageMaker.cri.page) }&bno=${board.bno }&prev=list&writer=${board.writer}','상세보기',600,400);">
