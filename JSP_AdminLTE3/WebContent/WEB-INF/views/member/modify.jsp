...
<!-- 						<input type="hidden" name="oldPicture" value="" /> -->
	              ...
	              <div class="card-footer">
	              	<div class="row">
			          	<button type="button" onclick="SubmitMemberRegist('form');" 
...
<form role="imageForm" action="upload/picture" method="post"  enctype="multipart/form-data">
	...
	<input id="oldFile" type="hidden" name="oldPicture" value="${member.picture }" />
	<input type="hidden" name="checkUpload" value="${empty member.picture ? '0' : '1' }" />	
	
	<!-- value=""에서 ""안에 JSTL을 사용하는 법도있다. 더럽게 길지만... -->
	<%-- <c:choose>
